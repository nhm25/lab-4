...
<head>
	<meta charset="UTF-8">
	<title>Volunteer Form Processing Script</title>
		<style>
		.box {
...
<body>
	<div style="text-align:center;">
		<h2>Volunteer Form Processing Script</h2>
		<p>This page will display the results of the form that was submitted to it.</p>
	</div>
	<hr><br>
	<h1>Thank you for your volunteer form submission, <?php echo htmlentities($firstName) ?>!</h1>
	<div class="box">
